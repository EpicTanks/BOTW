...
public class Weapon extends Item {
	...
	private String wType;
	private boolean isRanged;
	private String[][] weaponCatalogue = { { "Pistol", "Chicken Cooper", "Six-Shooter", "Super Shooter", "Brigadier" },
			{ "Rifle", "L.A.R.D.", "Screwball", "Big Man", "Bolt Action Riflee" },
			{ "Musket", "Old Musket", "War Relic", "Devil's Breath" }, { "Axe", "Axe", "Battleaxe" },
			{ "Staff", "Staff", "Ritual Staff" }, { "Sword", "Sword", "War Sabre", "Shank", "Knife" },
			{ "Special", "B.B. Boy", "Rail-Spike", "Club", "Arclight", "The Good Boy Gun", "Flamethrower" } };
